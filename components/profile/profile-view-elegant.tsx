    ...
    <div className="min-h-screen bg-white relative pb-24">
      ...
      <div className="relative z-10">
        ...
        {(profile.maritalStatus || profile.hasChildren || profile.wantChildren || profile.bioTagline) && (
          <div className="px-6 py-8 max-w-4xl mx-auto bg-white mt-8">
            <SectionDivider icon={User} title="Personal Details" color="blue" />
            <div className="grid grid-cols-2 gap-6 mt-8">
              {profile.bioTagline && (
                <div className="col-span-2 p-4 rounded-xl bg-gradient-to-r from-indigo-50 to-purple-50 border border-indigo-200/50">
                  <p className="text-xs font-semibold text-indigo-600 font-queensides mb-2 uppercase tracking-wide">Tagline</p>
              ...
              {profile.maritalStatus && (
                <div className="p-4 rounded-xl bg-gradient-to-r from-blue-50 to-indigo-50 border border-blue-200/50">
                  <p className="text-xs font-semibold text-blue-600 font-queensides mb-2 uppercase tracking-wide">Marital Status</p>
              ...
              {profile.hasChildren && (
                <div className="p-4 rounded-xl bg-gradient-to-r from-emerald-50 to-teal-50 border border-emerald-200/50">
                  <p className="text-xs font-semibold text-emerald-600 font-queensides mb-2 uppercase tracking-wide">Has Children</p>
                  <p className="text-slate-800 font-queensides text-lg capitalize">{profile.hasChildren}</p>
                </div>
              )}
              {profile.wantChildren && (
                <div className="p-4 rounded-xl bg-gradient-to-r from-pink-50 to-rose-50 border border-pink-200/50">
                  <p className="text-xs font-semibold text-pink-600 font-queensides mb-2 uppercase tracking-wide">Want Children</p>
                  <p className="text-slate-800 font-queensides text-lg capitalize">{profile.wantChildren}</p>
                </div>
              )}
            </div>
          </div>
        ...
        {(profile.education || profile.profession) && (
          <div className="px-6 py-8 max-w-4xl mx-auto bg-white">            
            <div className="grid grid-cols-2 gap-6">
              {profile.education && (
                <div className="p-4 rounded-xl bg-gradient-to-r from-blue-50 to-indigo-50 border border-blue-200/50">
                  <p className="text-xs font-semibold text-blue-600 font-queensides mb-2 uppercase tracking-wide">Education</p>
              ...
              {profile.profession && (
                <div className="p-4 rounded-xl bg-gradient-to-r from-emerald-50 to-teal-50 border border-emerald-200/50">
                  <p className="text-xs font-semibold text-emerald-600 font-queensides mb-2 uppercase tracking-wide">Profession</p>
            ...
            {(profile.alcohol || profile.smoking || profile.psychedelics || profile.halalFood) && (
              ...
              <div className="flex items-center space-x-4">
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
                  {profile.alcohol && (
                    <div className="p-4 rounded-xl bg-gradient-to-r from-amber-50 to-orange-50 border border-amber-200/50 text-center">
                      <p className="text-xs font-semibold text-amber-600 font-queensides mb-2 uppercase tracking-wide">Alcohol</p>
                      <p className="text-slate-800 font-queensides font-medium capitalize">{profile.alcohol}</p>
                    </div>
                  )}
                  {profile.smoking && (
                    <div className="p-4 rounded-xl bg-gradient-to-r from-amber-50 to-orange-50 border border-amber-200/50 text-center">
                      <p className="text-xs font-semibold text-amber-600 font-queensides mb-2 uppercase tracking-wide">Smoking</p>
                      <p className="text-slate-800 font-queensides font-medium capitalize">{profile.smoking}</p>
                    </div>
                  )}
                  {profile.psychedelics && (
                    <div className="p-4 rounded-xl bg-gradient-to-r from-amber-50 to-orange-50 border border-amber-200/50 text-center">
                      <p className="text-xs font-semibold text-amber-600 font-queensides mb-2 uppercase tracking-wide">Psychedelics</p>
                      ...
                      {profile.psychedelicsTypes && profile.psychedelicsTypes.length > 0 && (
                        <p className="text-xs text-slate-600 font-queensides mt-2">{profile.psychedelicsTypes.join(', ')}</p>
                      )}
                    </div>
                  )}
                  {profile.halalFood && (
                    <div className="p-4 rounded-xl bg-gradient-to-r from-amber-50 to-orange-50 border border-amber-200/50 text-center">
                      <p className="text-xs font-semibold text-amber-600 font-queensides mb-2 uppercase tracking-wide">Halal Food</p>
        ...
        {/* Lifestyle */}
        <div className="px-6 py-8 max-w-4xl mx-auto bg-white">
          <SectionDivider icon={PiggyBank} title="Finance Style" color="amber" />
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-6 mt-8">
            ...
            <div className="p-4 rounded-xl bg-gradient-to-r from-amber-50 to-orange-50 border border-amber-200/50 text-center">
              <Plane className="w-8 h-8 text-amber-500 mx-auto mb-2" />
              <p className="text-xs font-semibold text-amber-700 font-queensides mb-2 uppercase tracking-wider">Self Care</p>
              <p className="text-slate-800 font-queensides font-medium capitalize">{profile.travelFrequency ? profile.travelFrequency.replace('_', ' ') : 'Rarely'}</p>
            </div>
          ...
          {profile.gender === 'male' && profile.polygamyReason && (
            <div className="mt-8 p-6 rounded-xl bg-gradient-to-br from-amber-50 to-orange-50 border border-amber-200/50">
              <p className="text-sm font-semibold text-amber-700 font-queensides mb-2 uppercase tracking-wide">Polygamy Perspective</p>
        ...
        <div className="mt-10">
            <div className="flex items-center justify-center">
              <div className="flex items-center space-x-4">
                ...
                {profile.gender === 'male' && (
                    <>
                    <h3 className="text-lg font-bold text-slate-800 font-queensides mt-5 mb-6 text-center">Mahr Max Amount</h3>
                    <h1 className="text-2xl font-bold text-slate-800 font-queensides text-center">{profile.mahrMaxAmount || 'n/a'}</h1>
                    </>
                )}
                {profile.gender === 'female' && (
                    <>
                    <h3 className="text-lg font-bold text-slate-800 font-queensides mt-5 mb-6 text-center">Mahr Requirement</h3>
                    <h1 className="text-2xl font-bold text-slate-800 font-queensides text-center">{profile.mahrRequirement || 'n/a'}</h1>
                    </>
                )}
        ...
        {/* Living Arrangements & Marriage Preferences */}
        {(profile.livingArrangements || profile.willingToRelocate || profile.workPreference || profile.stylePreference) && (
          <div className="px-6 max-w-4xl mx-auto bg-white">
            <SectionDivider icon={Heart} title="Living & Marriage Preferences" color="violet" />
            ...
            <div className="grid grid-cols-2 gap-6 pb-10">
              {profile.livingArrangements && (
                <div className="p-4 rounded-xl bg-gradient-to-r from-violet-50 to-purple-50 border border-violet-200/50">
                  <p className="text-xs font-semibold text-violet-600 font-queensides mb-2 uppercase tracking-wide">Living Arrangements</p>
                  <p className="text-slate-800 font-queensides text-lg capitalize">{profile.livingArrangements.replace('_', ' ')}</p>
                </div>
              )}
              {profile.willingToRelocate && (
                <div className="p-4 rounded-xl bg-gradient-to-r from-violet-50 to-purple-50 border border-violet-200/50">
                  <p className="text-xs font-semibold text-violet-600 font-queensides mb-2 uppercase tracking-wide">Willing to Relocate</p>
                  <p className="text-slate-800 font-queensides text-lg capitalize">{profile.willingToRelocate}</p>
                </div>
              )}

              {profile.workPreference && profile.gender === 'female' && (
                <div className="p-4 rounded-xl bg-gradient-to-r from-violet-50 to-purple-50 border border-violet-200/50">
                  <p className="text-xs font-semibold text-violet-600 font-queensides mb-2 uppercase tracking-wide">Work Preference</p>
                  <p className="text-slate-800 font-queensides text-lg capitalize">{profile.workPreference.replace('_', ' ')}</p>
                </div>
              )}
              {profile.stylePreference && profile.gender === 'female' && (
                <div className="p-4 rounded-xl bg-gradient-to-r from-violet-50 to-purple-50 border border-violet-200/50">
                  <p className="text-xs font-semibold text-violet-600 font-queensides mb-2 uppercase tracking-wide">Style Preference</p>
                  <p className="text-slate-800 font-queensides text-lg capitalize">{profile.stylePreference.replace('_', ' ')}</p>
                </div>
              )}
            </div>
          </div>
