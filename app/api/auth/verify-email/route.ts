...
export async function PUT(request: NextRequest) {
  try {
    ...
    const verificationLink = `${process.env.NEXT_PUBLIC_APP_URL || process.env.NEXT_PUBLIC_SITE_URL || "https://samaa.app"}/auth/verify-email?token=${user.id}&email=${encodeURIComponent(email)}`
