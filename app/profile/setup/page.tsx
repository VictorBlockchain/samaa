...
export default function ProfileSetupPage() {
  ...
  useEffect(() => {
    ...
    const mapped = {
      ...
      shoppingFrequency: (profile as any).shopping_frequency_preference || "",
      hairStyle: (profile as any).hair_style || "",
      makeUpStyle: (profile as any).make_up_style || "",
      polygamyReason: (profile as any).polygamy_reason || "",
      selfCareFrequency: (profile as any).self_care_frequency_preference || "",
